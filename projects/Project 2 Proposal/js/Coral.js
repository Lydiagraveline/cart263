class Coral {
  ...
  for(let i = 0; i < this.verts; i++){
    this.nodes.push(new Node(this.x+this.r*sin(TWO_PI*i/this.verts),this.y+this.r*cos(TWO_PI*i/this.verts)));
  }
  }
}
